...
import ResearchComment from "./ResearchComment";
import { HiOutlineExclamationCircle } from "react-icons/hi";
import { Spinner } from "flowbite-react";

export default function ResearchCommentSection({ researchId }) {
  ...
  useEffect(() => {
    const getComments = async () => {
      try {
        const res = await fetch(`/api/comment/getPostComments/${researchId}`);
        if (res.ok) {
          const data = await res.json();
          setComments(data.comments);
